...
[open-job-letter](http://azu.github.io/open-job-letter/)についてのレポートです。
...
- [open-job-letter](http://azu.github.io/open-job-letter/)が細かく更新されていたため、応募方法はその影響を受けている可能性があります
...
- 有効な応募企業数: <ValidApplications />社

同一の企業が複数の応募をした場合には、(ハッシュ化された)企業名でユニーク化して1と数えています。

<q>有効な応募企業数</q>は[連絡手段](https://azu.github.io/open-job-letter/#%E9%80%A3%E7%B5%A1%E6%89%8B%E6%AE%B5)に記載した応募方法を利用した企業数です。
...
- 例） 上場企業が応募方法として"bosyu"を選んだ"応募数"といった対応関係を表しています
...
応募者のポジションとと応募方法の対応関係についてのグラフです。
